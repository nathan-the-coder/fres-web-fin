"""
FRES Database Layer — sqlite3 only, no ORM
"""
import sqlite3
import hashlib
...
def get_db() -> sqlite3.Connection:
    DB_PATH.parent.mkdir(parents=True, exist_ok=True)   # parents=True handles OneDrive/Windows paths
    conn = sqlite3.connect(str(DB_PATH))                # str() avoids Windows Path type issues
